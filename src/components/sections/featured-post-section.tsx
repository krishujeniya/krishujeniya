...
import { CardContent, CardDescription, CardFooter, CardHeader, CardTitle, cardHoverClasses } from '@/components/ui/card'; // Import cardHoverClasses
...
export const FeaturedPostSection: FC = () => { // Renamed component
  return (
    <AnimatedSection id="insights" className="container mx-auto px-4"> {/* Updated ID */}
      ...
      <GlassCard className={cn(
        "border border-border shadow-xl overflow-hidden max-w-4xl mx-auto flex flex-col md:flex-row group", // Added group
